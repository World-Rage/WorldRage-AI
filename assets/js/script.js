...
const GOOGLE_API_KEY = "AIzaSyCF8dDGBXXIc9FNftPW91TTJ8vmkvaOrqM";
    ...
    savedConversations.forEach(conversation => {
        const userMessageHtml = `
            ...
            <div class="message__content">
                <img class="message__avatar" src="assets/images/profile.png" alt="User avatar">
        ...
        const responseHtml = `
           ...
           <div class="message__content">
                <img class="message__avatar" src="assets/images/WorldRage_AI.jpg" alt="Gemini avatar">
